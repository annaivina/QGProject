...
def _transform(X, y, start=0, stop=-1):
    ...
    v['part_pid'] = PID
    v['part_isCHPlus'] = ak.values_astype((PID == 211) + (PID == 321) + (PID == 2212) + (PID == -3222) + (PID == 3222) + (PID == -3312), 'float32')
    v['part_isCHMinus'] = ak.values_astype((PID == -211) + (PID == -321) + (PID == -2212) + (PID == 3312) + (PID == -3112) + (PID == 3112) + (PID == 3334), 'float32')
    v['part_isNeutralHadron'] = ak.values_astype((PID == 130) + (PID == 2112) + (PID == -2112) + (PID == 3322) + (PID == -3322) + (PID == -3122) + (PID == 3122) + (PID == 310), 'float32')
