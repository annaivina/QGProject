...
cocoaout=${outdir}/500GeVHerwigZg/cocoa_herwig_Zg_500GeV_job${jobID}_Pseed${Pseed}_Cseed${jobID}_${Nevents}events.root
macro=${cocoadir}/macro/HepMC/Herwig/Zg/hepmc_Zjets_${Pseed}.in
