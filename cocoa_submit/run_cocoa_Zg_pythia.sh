...
cocoaout=${outdir}/500GeVPythiaZg/cocoa_Zgjets_500GeV_Pythia_job${jobID}_Pseed${Pseed}_Cseed${jobID}_${Nevents}events.root
macro=${cocoadir}/macro/HepMC/Zg/hepmc_Zjets_${Pseed}.in
