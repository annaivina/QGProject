...
int main(int argc, char** argv) {
    ...
    string outfile_name = "/storage/agrp/annai/QURK-GLUON/samples_produce/Pythia_Zqjets/500GeVjets/pythia_Zq_pT500_Seed";
    outfile_name  += argv[1];
    //outfile_name  += ".hepmc";
    outfile_name  += ".root";
    WriterRootTree  root_output( outfile_name );
    //WriterAscii hep_output(outfile_name);
